...
import { 
  ArrowRight, CheckCircle2, Users, Briefcase, UserCheck, 
  Search, Zap, ArrowLeft, Plus, Minus, GraduationCap, 
  ShieldCheck, Smartphone, Target, Globe
} from 'lucide-react';
...
const faqs = [
  {
    ...
    answer: "We provide end-to-end recruitment services including executive search, permanent staffing, temporary staffing, IT recruitment, and specialized hiring solutions across various industries like tech, manufacturing, and services."
  },
  {
    question: "How do you source the right talent for my business?",
    answer: "We use a multi-channel approach including our extensive internal database, professional networks (LinkedIn), job portals, and targeted headhunting to find candidates who match both your technical requirements and company culture."
  },
  {
    question: "Why should I use a professional recruitment agency?",
    answer: "Professional agencies save you significant time and resources. We handle the initial screening, technical assessments, and background checks, ensuring you only spend time interviewing the most qualified candidates."
  },
  {
    question: "What industries do you specialize in?",
    answer: "We have deep expertise in IT & Software, E-commerce, Manufacturing, Hospitality, and Corporate services. However, our proven recruitment methodology is effective for most professional sectors."
  },
  {
    question: "How long does it take to fill a position?",
    answer: "The timeline depends on the seniority and specialization of the role. Typically, we provide a shortlist of qualified candidates within 5-10 business days for standard roles."
  },
  {
    question: "Do you provide background verification services?",
    answer: "Yes, as part of our comprehensive hiring solution, we can conduct thorough background checks, including previous employment verification and educational qualification audits."
  },
  {
    question: "What are the key benefits of Kriscel tech recruitment?",
    answer: "Key benefits include access to high-skilled talent, reduced time-to-hire, improved quality of candidates, and a streamlined hiring process that allows your internal teams to focus on core operations."
  },
  {
    question: "Do you help with executive-level hiring?",
    answer: "Absolutely. We have a dedicated executive search team that specializes in finding leaders for senior management, director, and C-suite positions through discreet and targeted headhunting."
  },
  {
    question: "Which is the best recruitment agency in Delhi NCR?",
    answer: "The best agency is one that understands your unique business needs, provides pre-screened and high-quality candidates, and acts as a strategic partner in your brand's growth and team building."
  },
  {
    question: "How should I choose a recruitment partner?",
    answer: "Choose a partner who has a strong network in your industry, offers transparent communication throughout the process, and has a proven track record of successful long-term placements."
  }
];

const benefits = [
  {
    title: "Skilled Talent Sourcing",
    desc: "Access to a vast network of pre-screened professionals ready to contribute to your business success.",
    icon: <UserCheck className="text-accent" size={24} />
  },
  {
    title: "Efficient Hiring Cycles",
    desc: "Streamlined processes designed to reduce your time-to-hire without compromising on candidate quality.",
    icon: <Zap className="text-emerald-500" size={24} />
  },
  {
    title: "Executive Search",
    desc: "Discreet and targeted headhunting for senior leadership roles and specialized technical positions.",
    icon: <Target className="text-accent" size={24} />
  },
  {
    title: "Industry Specific Expertise",
    desc: "Knowledgeable recruiters who understand the nuances and required skillsets of your specific industry.",
    icon: <Briefcase className="text-amber-500" size={24} />
  },
  {
    title: "Background Verification",
    desc: "Ensuring every candidate you hire meets your standards through thorough previous employment audits.",
    icon: <ShieldCheck className="text-rose-500" size={24} />
  },
  {
    title: "Seamless Onboarding",
    desc: "Support throughout the final negotiation and onboarding phase to ensure a smooth start for your new hires.",
...
const KriscelFeatures = [
  {
    title: "Kriscel Tech Trusted Hiring Solutions",
    desc: "Helping businesses find skilled talent with efficient staffing and hiring solutions tailored to your needs."
  },
  {
    title: "Data-Driven Candidate Matching",
    desc: "We use advanced screening tools to match candidates to your technical requirements and brand culture efficiently."
  },
  {
    title: "Transparent Recruitment Pipeline",
    desc: "Stay updated on the status of every opening with our clear reporting and regular candidate shortlists."
  },
  {
    title: "Integrated Team Building",
    desc: "We don't just find employees; we help you build cohesive teams that are aligned with your long-term vision."
  },
  {
    title: "Global Reach, Local Expertise",
    desc: "Leverage our local knowledge in Delhi NCR combined with our ability to source talent from across India."
  },
  {
    title: "Scalable Staffing Solutions",
    desc: "Whether you need one key hire or need to scale an entire department, we adapt to your growth pace."
  }
];
    ...
    <main ref={containerRef} className="bg-white text-slate-900 pb-10 overflow-x-hidden selection:bg-accent selection:text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="col-span-1 lg:col-span-8 flex flex-col items-start text-left">
              ...
              <h1 className="hero-element text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter text-slate-950 leading-[0.95] uppercase mb-4">
                ...
                Solutions <span className="text-accent italic font-serif leading-normal normal-case mt-1 text-3xl md:text-4xl lg:text-5xl block">Partner.</span>
              </h1>
              <p className="hero-element text-sm md:text-base text-slate-500 font-medium leading-relaxed max-w-lg mb-6">
                Kriscel tech offers trusted recruitment services in Delhi NCR. We help businesses find skilled talent with efficient staffing and hiring solutions for sustainable team building.
              </p>
              
              <div className="hero-element mb-8">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-3">Professional Networks</p>
                  ...
                  <div className="absolute bottom-6 left-6 right-6 z-20 bg-white/20 backdrop-blur-md border border-white/30 p-4 rounded-2xl shadow-xl animate-in slide-in-from-bottom-4 duration-1000">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-[12px] font-bold text-slate-800">Talent Acquisition Active</p>
                      </div>
                    </div>
                  </div>
               </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-left mb-8 max-w-xl reveal-item">
            ...
            <h3 className="text-3xl md:text-4xl font-black text-slate-950 tracking-tight leading-[0.95]">
              Total Command Over <br className="hidden md:block"/> Your Team Growth.
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 reveal-grid">
            <div className="reveal-card col-span-1 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group">
               ...
               <h4 className="text-base font-bold text-slate-950 mb-2">Targeted Search</h4>
               <p className="text-slate-500 text-sm font-medium leading-relaxed">We use advanced headhunting techniques to find high-skilled talent for tech, management, and specialized roles.</p>
            </div>
            ...
            <div className="reveal-card col-span-1 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group">
               ...
               <h4 className="text-base font-bold text-slate-950 mb-2">Efficient Staffing</h4>
               <p className="text-slate-500 text-sm font-medium leading-relaxed">Reduce your time-to-hire significantly with our pre-screened talent pools and streamlined assessment processes.</p>
            </div>
            ...
            <div className="reveal-card col-span-1 bg-slate-950 p-6 rounded-2xl border border-slate-800 shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
               ...
               <h4 className="text-base font-bold text-white mb-2">Industry-Specific Hiring</h4>
               <p className="text-slate-300 text-sm font-medium leading-relaxed">Our experts understand the technicalities of your industry, providing you with candidates that have the perfect skillset.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative bg-slate-950 py-10 flex flex-col justify-center overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 w-full mb-6 relative z-10 text-center md:text-left reveal-item">
           <h2 className="text-xs font-black text-accent tracking-[0.2em] uppercase mb-2">Hiring Foundations</h2>
           <p className="text-2xl md:text-4xl font-black text-white tracking-tight max-w-xl leading-[1.05]">
             The right talent for sustainable business growth.
           </p>
        </div>
      ...
      <section className="relative z-10 py-12 bg-accent reveal-item">
         <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-4xl font-black text-white tracking-tight uppercase leading-[1.05] mb-4">
              Your People Are Your <br className="hidden md:block"/> Only Competitive Edge.
            </h2>
            <p className="text-white/80 text-sm md:text-base font-medium max-w-xl mx-auto mb-6 leading-relaxed">
              Don't compromise on hiring. Surround yourself with experts who are smarter, faster, and better. Let us find your next key team member.
            </p>
      ...
      <section className="relative z-10 py-10 bg-slate-50 border-t border-slate-100">
         <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-8 reveal-item">
               ...
               <p className="text-slate-500 text-sm font-medium">Everything you need to know about our recruitment methodology.</p>
            </div>
      ...
      <section className="mt-12 flex flex-col items-center text-center px-6 relative overflow-hidden pb-8 reveal-item">
         <div className="text-slate-100 text-[10vw] font-black tracking-tighter leading-[0.7] select-none opacity-50">HIRE</div>
         <div className="mt-[-2vw] relative z-10 flex flex-col items-center gap-6">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-slate-950 tracking-tight uppercase leading-[0.9]">Ready to Find <br /> Your Next High-Performer?</h2>
