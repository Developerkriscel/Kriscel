...
import { 
  ArrowRight, CheckCircle2, Wallet, PieChart, ShieldCheck, 
  BarChart4, ArrowLeft, Layers, Plus, Minus, Receipt, Activity, Settings
} from 'lucide-react';
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Account management helps businesses maintain long-term relationships with customers, track account activities, and identify opportunities for upselling or improving service. Effective account management increases customer satisfaction and revenue growth."
  },
  {
    question: "What features should a good account management system have?",
    answer: "A good account management system should include customer database management, interaction tracking, task management, reporting dashboards, workflow automation, and integration with CRM or ERP systems."
  },
  {
    question: "How does account management software improve customer relationships?",
    answer: "Account management software centralizes customer information and communication history, allowing teams to provide personalized service and respond to customer needs quickly. This helps build stronger and more consistent customer relationships."
  },
  {
    question: "Which operations does account management software handle?",
    answer: "Account management software can manage customer account records, communication history, sales interactions, follow-up tasks, support requests, and reporting activities."
  },
  {
    question: "Which industries benefit most from account management systems?",
    answer: "Industries such as IT services, finance, consulting, retail, manufacturing, and SaaS companies benefit from account management systems because they handle large numbers of customer accounts."
  },
  {
    question: "Can account management systems integrate with other platforms?",
    answer: "Yes, modern account management systems integrate with CRM platforms, ERP systems, accounting software, and communication tools to streamline business workflows and improve collaboration."
  },
  {
    question: "Is account management software suitable for small businesses?",
    answer: "Yes, account management software helps small businesses organize customer data, manage client relationships, and track interactions efficiently without relying on spreadsheets or manual processes."
  },
  {
    question: "Which is the best account management software for businesses in India?",
    answer: "The best account management software for businesses in India is one that provides centralized customer data management, automation tools, real-time reporting, and integration with existing business systems."
  },
  {
    question: "How should businesses choose account management software?",
    answer: "Businesses should choose account management software based on scalability, automation capabilities, integration options, reporting features, and ease of use to support efficient customer relationship management."
  }
];
...
const benefits = [
  {
    ...
    desc: "Manage all your accounts, invoices, and transactions from a single, easy-to-use dashboard for complete financial control.",
    icon: <PieChart className="text-accent" size={24} />
  },
  {
    title: "Time-Saving Automation",
    desc: "Automate routine accounting tasks like data entry, reconciliation, and reporting — saving time and minimizing manual errors.",
    icon: <Settings className="text-emerald-500" size={24} />
  },
  {
    title: "Real-Time Financial Tracking",
    desc: "Get instant visibility into cash flow, expenses, and account balances to make faster, more informed financial decisions.",
    icon: <Activity className="text-accent" size={24} />
  },
  {
    title: "Improved Accuracy & Transparency",
    desc: "Ensure 100% accuracy in records with automated calculations and transparent data tracking for all business activities.",
    icon: <BarChart4 className="text-accent" size={24} />
  },
  {
    title: "Streamlined Billing & Invoicing",
    desc: "Generate, send, and manage invoices effortlessly, reducing payment delays and improving client satisfaction.",
    icon: <Receipt className="text-rose-500" size={24} />
  },
  {
    title: "Secure Data Protection",
    desc: "Protect sensitive financial information with advanced security measures and controlled access—ensuring your data stays safe.",
...
const KriscelFeatures = [
  {
    ...
    desc: "Manage all client accounts from a single, intuitive dashboard. Track updates, monitor performance, and manage tasks efficiently — all in one place."
  },
  {
    title: "Automated Workflow Tracking",
    desc: "Say goodbye to manual follow-ups! Our system automatically updates task progress, sends reminders, and ensures no deadline is missed."
  },
  {
    title: "Real-Time Performance Insights",
    desc: "Access detailed analytics and performance reports in real-time. Get clear visibility into your account’s progress and key metrics."
  },
  {
    title: "Personalized Account Strategies",
    desc: "Our experts tailor strategies for each client to ensure consistent growth, improved engagement, and higher customer satisfaction."
  },
  {
  ...
  },
  {
    ...
    desc: "Whether you’re managing 10 or 1,000 accounts, our platform grows with you — backed by advanced security and reliable cloud performance."
  }
];

export default function AccountManagementSystem() {
  ...
  return (
    <main ref={containerRef} className="bg-white text-slate-900 pb-10 overflow-x-hidden selection:bg-accent selection:text-white">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute top-[20%] -right-[10%] w-[40%] h-[40%] bg-yellow-50/80 rounded-full blur-[100px] opacity-70"></div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="col-span-1 lg:col-span-8 flex flex-col items-start text-left">
              ...
              <p className="hero-element text-sm md:text-base text-slate-500 font-medium leading-relaxed max-w-lg mb-6">
                Streamline your operations with our advanced Account Management System—boost efficiency, optimize workflows, and deliver results faster than ever.
              </p>

              <div className="hero-element mb-8">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-3">Marketplace Synergy</p>
            ...
            <div className="col-span-1 lg:col-span-4 relative hero-element">
               <div className="relative w-full aspect-square md:aspect-[4/3] lg:aspect-square bg-slate-50 rounded-[2.5rem] border border-slate-100 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.1)] overflow-hidden group">
                  <div className="absolute inset-0 z-0">
                    <div className="absolute inset-0 bg-gradient-to-tr from-accent/10 via-transparent to-amber-500/10 mix-blend-overlay z-10" />
                    <img 
                      src="/images/account-mgmt-hero.png" 
                  ...
                  <div className="absolute bottom-6 left-6 right-6 z-20 bg-white/20 backdrop-blur-md border border-white/30 p-4 rounded-2xl shadow-xl animate-in slide-in-from-bottom-4 duration-1000">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-amber-600 rounded-lg flex items-center justify-center text-white shadow-lg">
                        <Wallet size={16} />
                      </div>
                      <div className="text-left">
                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-900 leading-tight">Live Status</p>
                        <p className="text-[12px] font-bold text-slate-800">Accounts Synced</p>
                      </div>
                    </div>
                  </div>
               </div>
      ...
      <section id="what-we-do" className="relative z-10 py-10 bg-slate-50 overflow-hidden">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-left mb-8 max-w-xl reveal-item">
            <h2 className="text-xs font-black text-amber-600 tracking-[0.2em] uppercase mb-2">What We Do</h2>
            <h3 className="text-3xl md:text-4xl font-black text-slate-950 tracking-tight leading-[0.95]">
              Total Command Over <br className="hidden md:block"/> Your Accounts.
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 reveal-grid">
            <div className="reveal-card col-span-1 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group">
               ...
               <h4 className="text-base font-bold text-slate-950 mb-2">AI-Powered Financial Management</h4>
               <p className="text-slate-500 text-sm font-medium leading-relaxed">Efficiently manage financial data, track transactions, and maintain accurate real-time records with an advanced AI-driven system.</p>
            </div>
            ...
            <div className="reveal-card col-span-1 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group">
               ...
               <h4 className="text-base font-bold text-slate-950 mb-2">Error-Free Bookkeeping</h4>
               <p className="text-slate-500 text-sm font-medium leading-relaxed">Ensure seamless account handling, reduce manual errors, and achieve complete financial transparency for businesses of any size.</p>
            </div>
            ...
            <div className="reveal-card col-span-1 bg-slate-950 p-6 rounded-2xl border border-slate-800 shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
               ...
               <h4 className="text-base font-bold text-white mb-2">Automation & Smart Decisions</h4>
               <p className="text-slate-300 text-sm font-medium leading-relaxed">Use automated processes, secure data management, and insightful analytics to save time and make smarter financial decisions.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative bg-slate-950 py-10 flex flex-col justify-center overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 w-full mb-6 relative z-10 text-center md:text-left reveal-item">
           <h2 className="text-xs font-black text-amber-400 tracking-[0.2em] uppercase mb-2">Benefits of Our Solution</h2>
      ...
      <section className="relative z-10 py-12 bg-accent reveal-item">
         <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-4xl font-black text-white tracking-tight uppercase leading-[1.05] mb-4">
              Every Financial Mistake Is <br className="hidden md:block"/> Losing You Money
            </h2>
            <p className="text-white/80 text-sm md:text-base font-medium max-w-xl mx-auto mb-6 leading-relaxed">
              Gain accuracy, speed, and real-time insights into your finances. Let us help you eliminate errors.
            </p>
      ...
      <section className="relative z-10 py-10 bg-white">
         <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-10 reveal-item">
               <h2 className="text-xs font-black text-amber-600 tracking-[0.2em] uppercase mb-2">The Kriscel Advantage</h2>
      ...
      <section className="relative z-10 py-10 bg-slate-50 border-t border-slate-100">
         <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-8 reveal-item">
               <h2 className="text-xs font-black text-amber-600 tracking-[0.2em] uppercase mb-2">Knowledge Base</h2>
               <h3 className="text-2xl md:text-4xl font-black text-slate-950 tracking-tight mb-4">
                  Frequently Asked Questions
               </h3>
               <p className="text-slate-500 text-sm font-medium">Everything you need to know about our Account Management System.</p>
            </div>
               ...
               {faqs.map((faq, idx) => (
                  <div key={idx} className="bg-white border border-slate-200 rounded-xl overflow-hidden transition-all duration-300 hover:border-slate-300 shadow-sm">
                     ...
                     >
                        ...
                        <div className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 transition-colors ${openFaq === idx ? 'bg-amber-50 text-amber-600' : 'bg-slate-50 text-slate-400'}`}>
      ...
      <section className="mt-12 flex flex-col items-center text-center px-6 relative overflow-hidden pb-8 reveal-item">
         <div className="text-slate-100 text-[10vw] font-black tracking-tighter leading-[0.7] select-none opacity-50">ACCOUNTS</div>
         <div className="mt-[-2vw] relative z-10 flex flex-col items-center gap-6">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-slate-950 tracking-tight uppercase leading-[0.9]">Ready to Optimize <br /> Your Accounting?</h2>
