      ...
      <section ref={partnersRef} className="py-24 px-6 bg-slate-950 overflow-hidden relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { name: "KRISHNA OVERSEAS (KOI)", src: "/images/clients/koi.webp", color: "#a855f7" },
              { name: "KRISCEL TECH", src: "/images/kriscel-logo.png", color: "#4338ca" },
              { name: "SAFE CORD", src: "/images/clients/safecord.png", color: "#06b6d4" },
              { name: "FIRE INDUSTRIAL (PELLET)", src: "/images/clients/pellet.webp", color: "#10b981" },
              { name: "PRIUS AUTO", src: "/images/clients/prius.webp", color: "#f59e0b" },
              { name: "GLOBAL PARTNER", src: "/images/clients/global.webp", color: "#3b82f6" },
              { name: "JIVO WELLNESS", src: "/images/clients/jivo.png", color: "#22c55e" },
              { name: "PAL ENGINEERING", src: "/images/clients/pal.avif", color: "#f43f5e" }
            ].map((client, i) => (
              <div 
                key={i}
              ...
              >
                ...
                <div className="relative mb-6 filter grayscale group-hover:grayscale-0 transition-all duration-700 brightness-110">
                  <Image 
                    src={client.src} 
                    alt={client.name} 
                    width={160} 
