...
import { 
  ArrowRight, CheckCircle2, Share2, Users, MessageCircle, 
  BarChart, Heart, Zap, ArrowLeft, Plus, Minus, Hash, 
  Rocket, Sparkles
} from 'lucide-react';
...
const faqs = [
  {
    ...
    answer: "Social media marketing is a digital marketing strategy that uses social media platforms to promote products or services, build brand awareness, and engage with target audiences through content, advertising, and communication."
  },
  {
    question: "Why is social media marketing important for businesses?",
    answer: "Social media marketing helps businesses connect with their audience, increase brand visibility, and generate leads. It allows companies to interact directly with customers and build long-term relationships online."
  },
  {
    question: "Which social media platforms should my business use?",
    answer: "Popular platforms include Facebook, Instagram, LinkedIn, Twitter (X), YouTube, and TikTok. Businesses should choose platforms based on their target audience and marketing goals."
  },
  {
    question: "What are the benefits of social media marketing?",
    answer: "It helps increase brand awareness, drive website traffic, generate leads, and build customer loyalty. It also allows businesses to engage with their audience in real time and monitor customer feedback."
  },
  {
    question: "How does social media marketing generate leads?",
    answer: "By sharing valuable content, running targeted advertisements, and directing users to landing pages or websites where they can learn more about products or services."
  },
  {
    question: "What services are included in social media marketing?",
    answer: "Services Typically include content creation, social media account management, advertising campaigns, audience targeting, analytics reporting, and engagement management."
  },
  {
    question: "Is social media marketing effective for small businesses?",
    answer: "Yes, it provides a cost-effective way to reach potential customers, promote products, and build brand awareness online."
  },
  {
    question: "How often should businesses post on social media?",
    answer: "Most brands post several times per week to maintain consistent engagement. The frequency depends on the platform and audience expectations."
  },
  {
    question: "Which is the best social media marketing service in India?",
    answer: "The best service provider is one that offers strategic content planning, targeted advertising, analytics tracking, and audience engagement to help brands grow online."
  },
  {
    question: "How should I choose a social media marketing agency?",
    answer: "Choose based on experience, proven results, creative content strategies, transparent reporting, and the ability to manage campaigns across multiple platforms."
  }
];
...
const benefits = [
  {
    ...
    desc: "We optimize your social media profiles for maximum visibility, branding, and professional impact.",
    icon: <Users className="text-pink-500" size={24} />
  },
  {
    title: "Audience Engagement",
    desc: "Active community management, responding to queries, and building lasting relationships with your followers.",
    icon: <MessageCircle className="text-purple-500" size={24} />
  },
  {
    title: "Ad Campaign Management",
    desc: "Running targeted paid campaigns to reach your ideal audience effectively and maximize your budget.",
    icon: <Rocket className="text-accent" size={24} />
  },
  {
    title: "Analytics & Reporting",
    desc: "Comprehensive tracking of performance, reach, and ROI to continuously refine and improve strategies.",
    icon: <BarChart className="text-rose-500" size={24} />
  },
  {
    title: "Creative Content",
    desc: "Scroll-stopping visuals and catchy captions designed to inspire interaction and drive sales.",
    icon: <Sparkles className="text-amber-500" size={24} />
  },
  {
    title: "Growth Strategy",
    desc: "Data-driven social campaigns designed to connect with your audience and deliver measurable results.",
...
const KriscelFeatures = [
  {
    title: "Data-Driven Social Strategies",
    desc: "We design campaigns backed by real-time insights, ensuring every post and ad delivers measurable ROI."
  },
  {
    title: "AI-Powered Audience Targeting",
    desc: "Smart algorithms pinpoint the right audience, optimize ad delivery, and enhance engagement across all platforms."
  },
  {
    title: "Transparent Performance Tracking",
    desc: "Access real-time reports showcasing reach, clicks, and conversions — full visibility into your growth."
  },
  {
    title: "Creative Content that Converts",
    desc: "From visuals to captions, our team creates content that inspires interaction, builds trust, and drives conversions."
  },
  {
    title: "Dedicated Social Media Experts",
    desc: "Our experts actively monitor, manage, and optimize your campaigns to ensure consistent peak performance."
  },
  {
    title: "Scalable Growth Solutions",
    desc: "Whether a startup or recognized brand, we help you scale your social presence strategically."
  }
];
  ...
  return (
    <main ref={containerRef} className="bg-white text-slate-900 pb-10 overflow-x-hidden selection:bg-accent selection:text-white">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] bg-pink-50 rounded-full blur-[120px] opacity-70"></div>
        <div className="absolute top-[20%] -right-[10%] w-[40%] h-[40%] bg-purple-50/80 rounded-full blur-[100px] opacity-70"></div>
      </div>

      {/* HERO SECTION */}
      <section className="relative z-10 min-h-[50vh] flex flex-col justify-center pt-28 pb-8 border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6 w-full">
          <Link href="/solutions" className="hero-element inline-flex items-center gap-1.5 text-[10px] font-black tracking-widest text-pink-600 hover:text-pink-800 transition-colors mb-6 uppercase group bg-pink-50 px-3 py-1.5 rounded-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="col-span-1 lg:col-span-8 flex flex-col items-start text-left">
              ...
              <div className="hero-element mb-8">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-3">Community Synergy</p>
              ...
              <div className="hero-element flex flex-wrap gap-3">
            ...
            </div>            <div className="col-span-1 lg:col-span-4 relative hero-element">
               <div className="relative w-full aspect-square md:aspect-[4/3] lg:aspect-square bg-slate-50 rounded-[2.5rem] border border-slate-100 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.1)] overflow-hidden group">
                  <div className="absolute inset-0 z-0">
                    <div className="absolute inset-0 bg-gradient-to-tr from-purple-500/10 via-transparent to-pink-500/10 mix-blend-overlay z-10" />
                    <img 
                      src="/images/smo-hero.png" 
                  ...
                  <div className="absolute bottom-6 left-6 right-6 z-20 bg-white/20 backdrop-blur-md border border-white/30 p-4 rounded-2xl shadow-xl animate-in slide-in-from-bottom-4 duration-1000">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-pink-600 rounded-lg flex items-center justify-center text-white shadow-lg">
                        <TrendingUp size={16} />
                      </div>
                      <div className="text-left">
                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-900 leading-tight">Live Engagement</p>
                        <p className="text-[12px] font-bold text-slate-800">Viral Trend Active</p>
                      </div>
                    </div>
                  </div>
               </div>
      ...
      <section id="what-we-do" className="relative z-10 py-10 bg-slate-50 overflow-hidden">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-left mb-8 max-w-xl reveal-item">
            <h2 className="text-xs font-black text-pink-600 tracking-[0.2em] uppercase mb-2">What We Do</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 reveal-grid">
            <div className="reveal-card col-span-1 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group">
               <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 group-hover:bg-pink-50 transition-all">
                  <Sparkles className="text-pink-600" size={20} />
               </div>
               <h4 className="text-base font-bold text-slate-950 mb-2">Creative Content Strategy</h4>
               <p className="text-slate-500 text-sm font-medium leading-relaxed">From scroll-stopping visuals to catchy captions, our team creates content that inspires interaction and builds trust.</p>
            </div>
            
            <div className="reveal-card col-span-1 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group">
               <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 group-hover:bg-purple-50 transition-all">
                  <Zap className="text-purple-600" size={20} />
               </div>
               <h4 className="text-base font-bold text-slate-950 mb-2">AI-Powered Targeting</h4>
               <p className="text-slate-500 text-sm font-medium leading-relaxed">Our smart algorithms pinpoint the right audience, optimize ad delivery, and enhance engagement across all major platforms.</p>
            </div>
            ...
            <div className="reveal-card col-span-1 bg-slate-950 p-6 rounded-2xl border border-slate-800 shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
               <div className="absolute top-0 right-0 w-32 h-32 bg-pink-500/20 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
               ...
               <h4 className="text-base font-bold text-white mb-2">Social Analytics</h4>
               <p className="text-slate-300 text-sm font-medium leading-relaxed">Track performance, measure engagement, and turn insights into smarter growth decisions with full transparency.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative bg-slate-950 py-10 flex flex-col justify-center overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 w-full mb-6 relative z-10 text-center md:text-left reveal-item">
           <h2 className="text-xs font-black text-pink-400 tracking-[0.2em] uppercase mb-2">Growth Foundations</h2>
      ...
      <section className="relative z-10 py-12 bg-accent reveal-item">
         <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-4xl font-black text-white tracking-tight uppercase leading-[1.05] mb-4">
              Posting Isn’t Marketing. <br className="hidden md:block"/> Converting Is.
            </h2>
            <p className="text-white/80 text-sm md:text-base font-medium max-w-xl mx-auto mb-6 leading-relaxed">
              If your social media isn’t generating revenue, it’s costing you time and money. Turn your followers into customers today.
            </p>
      ...
      <section className="relative z-10 py-10 bg-white">
         <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-10 reveal-item">
               <h2 className="text-xs font-black text-pink-600 tracking-[0.2em] uppercase mb-2">The Kriscel Advantage</h2>
               ...
               {KriscelFeatures.map((feature, idx) => (
                  <div key={idx} className="reveal-card flex gap-4">
                     <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center shrink-0 border border-slate-100 shadow-sm">
                        <CheckCircle2 className="text-pink-600" size={16} />
                     </div>
                     <div>
      ...
      <section className="relative z-10 py-10 bg-slate-50 border-t border-slate-100">
         <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-8 reveal-item">
               <h2 className="text-xs font-black text-pink-600 tracking-[0.2em] uppercase mb-2">Knowledge Base</h2>
               <h3 className="text-2xl md:text-4xl font-black text-slate-950 tracking-tight mb-4">
                  Frequently Asked Questions
               </h3>
               <p className="text-slate-500 text-sm font-medium">Insights and information about our Social Media Optimization services.</p>
            </div>
               ...
               {faqs.map((faq, idx) => (
                  <div key={idx} className="bg-white border border-slate-200 rounded-xl overflow-hidden transition-all duration-300 hover:border-slate-300 shadow-sm">
                     ...
                     >
                        ...
                        <div className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 transition-colors ${openFaq === idx ? 'bg-pink-50 text-pink-600' : 'bg-slate-50 text-slate-400'}`}>
      ...
      <section className="mt-12 flex flex-col items-center text-center px-6 relative overflow-hidden pb-8 reveal-item">
         <div className="text-slate-100 text-[10vw] font-black tracking-tighter leading-[0.7] select-none opacity-50">SOCIAL</div>
         <div className="mt-[-2vw] relative z-10 flex flex-col items-center gap-6">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-slate-950 tracking-tight uppercase leading-[0.9]">Ready to Scale <br /> Your Brand?</h2>
