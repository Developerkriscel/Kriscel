...
import { 
  ArrowRight, CheckCircle2, ClipboardList, Target, Clock, 
  Users, BarChart2, Layers, Zap, CalendarDays, BrainCircuit,
  MessageSquare, Plus, Minus, ArrowLeft
} from 'lucide-react';
...
const faqs = [
  {
    question: "What is an employee task management system?",
    answer: "An employee task management system is software that helps businesses create, assign, and track tasks for employees. It allows managers to monitor task progress, set deadlines, and ensure that work is completed efficiently across teams."
  },
  {
    question: "Why is employee task management important?",
    answer: "Employee task management helps organizations improve productivity by clearly assigning responsibilities and tracking progress. It ensures that employees understand their tasks, meet deadlines, and collaborate effectively with team members."
  },
  {
    question: "What features should a good employee task management system include?",
    answer: "A good employee task management system should include task assignment, deadline tracking, workflow management, team collaboration tools, reporting dashboards, and integration with project or HR systems."
  },
  {
    question: "How does employee task management software improve productivity?",
    answer: "Employee task management software improves productivity by organizing tasks, prioritizing work, and providing real-time visibility into task progress. It helps teams stay aligned and complete projects on time."
  },
  {
    question: "Which tasks can employee task management software manage?",
    answer: "Employee task management software can manage daily work assignments, project tasks, team collaboration activities, workflow approvals, progress tracking, and performance monitoring."
  },
  {
    question: "Which industries benefit most from employee task management systems?",
    answer: "Industries such as IT services, manufacturing, marketing agencies, consulting firms, retail companies, and corporate organizations benefit greatly from employee task management systems because they manage multiple tasks and team workflows."
  },
  {
    question: "Can employee task management systems integrate with other tools?",
    answer: "Yes, modern employee task management systems integrate with project management tools, HR software, CRM systems, and communication platforms to improve workflow efficiency and collaboration."
  },
  {
    question: "Is employee task management software helpful for small businesses?",
    answer: "Yes, employee task management software helps small businesses organize team tasks, improve productivity, and manage projects effectively without requiring complex project management systems."
  },
  {
    question: "Which is the best employee task management software for businesses in India?",
    answer: "The best employee task management software for businesses in India is one that offers task assignment, workflow automation, real-time progress tracking, and reporting tools to help teams manage work efficiently."
  },
  {
    question: "How should businesses choose employee task management software?",
    answer: "Businesses should choose employee task management software based on ease of use, automation capabilities, collaboration tools, integration options, and reporting features to ensure efficient team management."
  }
];
...
const benefits = [
  {
    ...
    desc: "Easily assign, track, and manage all employee tasks from a single dashboard — ensuring nothing slips through the cracks.",
    icon: <ClipboardList className="text-accent" size={24} />
  },
  {
    title: "Improved Team Productivity",
    desc: "Automate routine workflows and boost team efficiency with clear priorities, real-time updates, and better collaboration.",
    icon: <Zap className="text-emerald-500" size={24} />
  },
  {
    title: "Real-Time Performance Tracking",
    desc: "Monitor employee progress, deadlines, and task completion status instantly to identify top performers and areas for improvement.",
    icon: <Target className="text-accent" size={24} />
  },
  {
    title: "Smart Task Scheduling",
    desc: "Plan and schedule tasks efficiently with deadline reminders and priority management. Automated notifications ensure employees stay on track.",
    icon: <CalendarDays className="text-accent" size={24} />
  },
  {
    title: "Performance Analytics & Reports",
    desc: "Get detailed insights into employee productivity with automated reports, analytics dashboards, and customizable KPIs.",
    icon: <BarChart2 className="text-rose-500" size={24} />
  },
  {
    title: "Seamless Integration",
    desc: "Easily integrate with popular tools like CRM systems, communication platforms, and analytics tools to create a unified workflow.",
...
const KriscelFeatures = [
  {
    ...
    desc: "Leverage intelligent analytics to identify top performers, track efficiency trends, and optimize team output effortlessly."
  },
  {
    title: "Transparent Progress Reporting",
    desc: "Get detailed dashboards with live task status, deadlines, and performance metrics — ensuring complete project visibility."
  },
  {
    title: "Collaboration-Driven Workflow",
    desc: "Empower your teams with a unified workspace for communication, file sharing, and updates — minimizing delays and confusion."
  },
  {
    title: "Personalized Employee Dashboard",
    desc: "Each employee gets a clear overview of tasks, deadlines, and performance summaries for self-monitoring and accountability."
  },
  {
    title: "Smart Task Allocation & Tracking",
    desc: "Easily assign, monitor, and prioritize tasks in real-time to boost productivity and ensure every project stays on track."
  },
  {
    title: "Scalable for Teams of Any Size",
    desc: "Whether you manage a small team or a large organization, our system adapts seamlessly to your workflow and growth needs."
  }
];
    ...
    <main ref={containerRef} className="bg-white text-slate-900 pb-10 overflow-x-hidden selection:bg-accent selection:text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="col-span-1 lg:col-span-8 flex flex-col items-start text-left">
              ...
              <h1 className="hero-element text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter text-slate-950 leading-[0.95] uppercase mb-4">
                Employee Task <br className="hidden md:block" />
              ...
              <p className="hero-element text-sm md:text-base text-slate-500 font-medium leading-relaxed max-w-lg mb-6">
                Streamline your operations with our advanced Employee Task Management System—boost efficiency, optimize workflows, and deliver results faster than ever.
              </p>
            ...
            <div className="col-span-1 lg:col-span-4 relative hero-element">
               <div className="relative w-full aspect-square md:aspect-[4/3] lg:aspect-square bg-slate-50 rounded-[2.5rem] border border-slate-100 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.1)] overflow-hidden group">
                  <div className="absolute inset-0 z-0">
                    <div className="absolute inset-0 bg-gradient-to-tr from-accent/10 via-transparent to-emerald-500/10 mix-blend-overlay z-10" />
                    <img 
                      src="/images/employee-task-hero.png" 
                      alt="Employee Task Management System"
                  ...
                  <div className="absolute bottom-6 left-6 right-6 z-20 bg-white/20 backdrop-blur-md border border-white/30 p-4 rounded-2xl shadow-xl animate-in slide-in-from-bottom-4 duration-1000">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-[12px] font-bold text-slate-800">Tasks Synced</p>
                      </div>
                    </div>
                  </div>
               </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-left mb-8 max-w-xl reveal-item">
            ...
            <h3 className="text-3xl md:text-4xl font-black text-slate-950 tracking-tight leading-[0.95]">
              Total Command Over <br className="hidden md:block"/> Your Workflows.
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 reveal-grid">
            <div className="reveal-card col-span-1 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group">
               ...
               <h4 className="text-base font-bold text-slate-950 mb-2">AI-powered Employee Task Management</h4>
               <p className="text-slate-500 text-sm font-medium leading-relaxed">It helps businesses streamline workflows, assign tasks efficiently, and monitor employee performance in real time.</p>
            </div>
            ...
            <div className="reveal-card col-span-1 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group">
               ...
               <h4 className="text-base font-bold text-slate-950 mb-2">Improved coordination and productivity</h4>
               <p className="text-slate-500 text-sm font-medium leading-relaxed">Supports both small teams and large organizations by enhancing teamwork, reducing errors, and increasing overall efficiency.</p>
            </div>
            ...
            <div className="reveal-card col-span-1 bg-slate-950 p-6 rounded-2xl border border-slate-800 shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
               ...
               <h4 className="text-base font-bold text-white mb-2">Complete task visibility</h4>
               <p className="text-slate-300 text-sm font-medium leading-relaxed">Provides clear control over every task, saving time and helping businesses achieve their goals faster.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative bg-slate-950 py-10 flex flex-col justify-center overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 w-full mb-6 relative z-10 text-center md:text-left reveal-item">
           <h2 className="text-xs font-black text-emerald-400 tracking-[0.2em] uppercase mb-2">Benefits of Our Task System</h2>
      ...
      <section className="relative z-10 py-12 bg-accent reveal-item">
         <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-4xl font-black text-white tracking-tight uppercase leading-[1.05] mb-4">
              Stop Paying for Work <br className="hidden md:block"/> That Doesn’t Get Done
            </h2>
            <p className="text-white/80 text-sm md:text-base font-medium max-w-xl mx-auto mb-6 leading-relaxed">
              Track performance, enforce accountability, and improve output instantly with our task management system.
            </p>
      ...
      <section className="relative z-10 py-10 bg-slate-50 border-t border-slate-100">
         <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-8 reveal-item">
               ...
               <p className="text-slate-500 text-sm font-medium">Everything you need to know about our Task Management System.</p>
            </div>
      ...
      <section className="mt-12 flex flex-col items-center text-center px-6 relative overflow-hidden pb-8 reveal-item">
         <div className="text-slate-100 text-[10vw] font-black tracking-tighter leading-[0.7] select-none opacity-50">TASKS</div>
         <div className="mt-[-2vw] relative z-10 flex flex-col items-center gap-6">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-slate-950 tracking-tight uppercase leading-[0.9]">Ready to Boost <br /> Productivity?</h2>
