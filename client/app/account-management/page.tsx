...
import { 
  ArrowRight, CheckCircle2, BarChart3, Settings2, Package, 
  RotateCw, Zap, ArrowLeft, Plus, Minus, LayoutGrid, 
  ShieldCheck, Smartphone, LineChart, Layers
} from 'lucide-react';
...
const faqs = [
  {
    question: "What is e-commerce account management?",
    answer: "E-commerce account management is a service where experts handle the daily operations of your seller accounts on platforms like Amazon and Flipkart. This includes inventory updates, order processing, pricing management, and performance monitoring to ensure sustainable growth."
  },
  {
    question: "Why should I outsource my e-commerce account management?",
    answer: "Outsourcing allows you to focus on product sourcing and brand building while experts handle the technicalities and day-to-day tasks. It ensures your account remains healthy, complies with marketplace policies, and stays competitive."
  },
  {
    question: "What platforms do you manage?",
    answer: "We manage all major e-commerce platforms including Amazon, Flipkart, Meesho, Myntra, Jiomart, and international marketplaces like eBay and Etsy."
  },
  {
    question: "How do you improve my sales through account management?",
    answer: "We use data-driven insights to optimize pricing, manage promotions, ensure inventory availability, and improve search visibility through catalog refinements and targeted advertising."
  },
  {
    question: "What are the key benefits of this service?",
    answer: "Key benefits include saved time, reduced operational errors, improved account health scores, better inventory turnover, and a significant increase in overall sales and profitability."
  },
  {
    question: "Do you handle customer inquiries and returns?",
    answer: "Yes, our comprehensive management includes monitoring customer feedback, responding to inquiries, and managing the returns process to ensure high customer satisfaction and minimal impact on profit."
  },
  {
    question: "How do you track performance?",
    answer: "We provide regular, detailed reports on key metrics such as total sales, conversion rates, account health, top-performing products, and advertising ROI to keep you informed of your brand's progress."
  },
  {
    question: "Is this service suitable for established brands?",
    answer: "Yes, we help established brands scale further by optimizing their multi-channel operations and implementing advanced growth strategies that internal teams might miss."
  },
  {
    question: "Which is the best e-commerce account management company in Delhi?",
    answer: "The best company is one that provides transparent reporting, has extensive experience across multiple marketplaces, and focuses on ROI-driven strategies for long-term brand success."
  },
  {
    question: "How should I choose a management partner?",
    answer: "Choose a partner who understands your industry, has a proven track record of growing marketplace accounts, and offers customizable services that fit your specific business needs."
  }
];
...
const benefits = [
  {
    ...
    desc: "Real-time monitoring of stock levels across all platforms to prevent stockouts and overstocking issues.",
    icon: <Package className="text-accent" size={24} />
  },
  {
    title: "Order Management",
    desc: "Seamless processing and tracking of customer orders to ensure timely delivery and high satisfaction.",
    icon: <Layers className="text-emerald-500" size={24} />
  },
  {
    title: "Performance Metrics",
    desc: "Continuous monitoring of account health, conversion rates, and sales trends to drive data-backed decisions.",
    icon: <BarChart3 className="text-accent" size={24} />
  },
  {
    title: "Pricing Strategy",
    desc: "Dynamic management of product pricing and promotions to stay competitive while protecting your margins.",
    icon: <Zap className="text-amber-500" size={24} />
  },
  {
    title: "Compliance & Safety",
    desc: "Ensuring your account strictly follows marketplace policies to avoid penalties or suspension risks.",
    icon: <ShieldCheck className="text-rose-500" size={24} />
  },
  {
    title: "Automation Tools",
    desc: "Integration of smart tools to automate repetitive tasks, saving you hours of manual operational work ogni giorno.",
    icon: <RotateCw className="text-accent" size={24} />
  }
];

const KriscelFeatures = [
  {
    title: "Expert Marketplace Management",
    desc: "Focus on your products while we handle the complexities of Amazon, Flipkart, and other major platforms."
  },
  {
    title: "Real-Time Account Visibility",
    desc: "Stay informed with intuitive dashboards that show your sales, inventory, and health status at a glance."
  },
  {
    title: "ROI-Focused Growth Strategy",
    desc: "We don't just manage; we optimize. Every action is designed to increase your sales velocity and profitability."
  },
  {
    title: "Dedicated Account Support",
    desc: "Your business gets a dedicated specialist who actively manages and scales your digital presence daily."
  },
  {
    title: "Seamless Integrated Solutions",
    desc: "Connect your marketplace accounts with your internal ERPs and CRMs for a unified business overview."
  },
  {
    title: "Scalable Operations Framework",
    desc: "Our management systems grow with you, allowing you to add more products and channels without friction."
  }
];
  ...
  return (
    <main ref={containerRef} className="bg-white text-slate-900 pb-10 overflow-x-hidden selection:bg-accent selection:text-white">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute top-[20%] -right-[10%] w-[40%] h-[40%] bg-slate-50/80 rounded-full blur-[100px] opacity-70"></div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="col-span-1 lg:col-span-8 flex flex-col items-start text-left">
              ...
              <div className="hero-element mb-8">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-3">Supported Platforms</p>
            ...
            <div className="col-span-1 lg:col-span-4 relative hero-element">
               <div className="relative w-full aspect-square md:aspect-[4/3] lg:aspect-square bg-slate-50 rounded-[2.5rem] border border-slate-100 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.1)] overflow-hidden group">
                  <div className="absolute inset-0 z-0">
                    ...
                    <img 
                      src="/images/e-com-mgmt-hero.png" 
                      alt="E-Commerce Account Management"
                  ...
                  <div className="absolute bottom-6 left-6 right-6 z-20 bg-white/20 backdrop-blur-md border border-white/30 p-4 rounded-2xl shadow-xl animate-in slide-in-from-bottom-4 duration-1000">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-[12px] font-bold text-slate-800">Account Health: Excellent</p>
                      </div>
                    </div>
                  </div>
               </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-left mb-8 max-w-xl reveal-item">
            ...
            <h3 className="text-3xl md:text-4xl font-black text-slate-950 tracking-tight leading-[0.95]">
              Full-Scale marketplace <br className="hidden md:block"/> Operations.
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 reveal-grid">
            <div className="reveal-card col-span-1 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group">
               ...
               <h4 className="text-base font-bold text-slate-950 mb-2">Omnichannel Mastery</h4>
               <p className="text-slate-500 text-sm font-medium leading-relaxed">We manage your presence across Amazon, Flipkart, and more, ensuring a consistent brand experience everywhere.</p>
            </div>
            ...
            <div className="reveal-card col-span-1 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group">
               ...
               <h4 className="text-base font-bold text-slate-950 mb-2">Inventory Management</h4>
               <p className="text-slate-500 text-sm font-medium leading-relaxed">Integrated tracking to optimize stock levels, prevent losses, and ensure you never miss a sale opportunity.</p>
            </div>
            ...
            <div className="reveal-card col-span-1 bg-slate-950 p-6 rounded-2xl border border-slate-800 shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
               ...
               <h4 className="text-base font-bold text-white mb-2">Scalable Growth</h4>
               <p className="text-slate-300 text-sm font-medium leading-relaxed">Data-driven performance insights that help you scale globally with efficiency and complete operational transparency.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative bg-slate-950 py-10 flex flex-col justify-center overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 w-full mb-6 relative z-10 text-center md:text-left reveal-item">
           <h2 className="text-xs font-black text-accent tracking-[0.2em] uppercase mb-2">Management Foundations</h2>
           <p className="text-2xl md:text-4xl font-black text-white tracking-tight max-w-xl leading-[1.05]">
             Value-driven strategies for modern B2C sellers.
           </p>
        </div>
      ...
      <section className="relative z-10 py-12 bg-accent reveal-item">
         <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-4xl font-black text-white tracking-tight uppercase leading-[1.05] mb-4">
              Stop Busy Work. Start <br className="hidden md:block"/> Business Growth.
            </h2>
            <p className="text-white/80 text-sm md:text-base font-medium max-w-xl mx-auto mb-6 leading-relaxed">
              If your team is buried in marketplace technicalities, they aren't building your brand. Let our specialists handle the operational excellence for you.
            </p>
      ...
      <section className="relative z-10 py-10 bg-slate-50 border-t border-slate-100">
         <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-8 reveal-item">
               ...
               <p className="text-slate-500 text-sm font-medium">Everything you need to know about professional marketplace management.</p>
            </div>
      ...
      <section className="mt-12 flex flex-col items-center text-center px-6 relative overflow-hidden pb-8 reveal-item">
         <div className="text-slate-100 text-[10vw] font-black tracking-tighter leading-[0.7] select-none opacity-50">MANAGE</div>
         <div className="mt-[-2vw] relative z-10 flex flex-col items-center gap-6">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-slate-950 tracking-tight uppercase leading-[0.9]">Ready to Scale <br /> Your Online Sales?</h2>
